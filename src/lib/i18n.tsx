...
const T: Record<Lang, Dict> = {
  en: {
    ...
    term_deposit: "Deposit from 100 USD",
  ...
  ka: {
    ...
    term_deposit: "დეპოზიტი 100 USD-დან",
  ...
  ru: {
    ...
    term_deposit: "Депозит от 100 USD",
  ...
  he: {
    ...
    term_deposit: "דיפוזיט מ-100 USD",
  ...
  tr: {
    ...
    term_deposit: "100 USD'den depozito",

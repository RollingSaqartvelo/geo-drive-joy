...
export const KAKHA_CARS = ["toyota-rav4-white", "toyota-rav4-hybrid", "subaru-crosstrek-limited", "subaru-crosstrek-black", "ford-fusion-plugin", "lexus-ct200h", "toyota-highlander", "toyota-sienna", "hyundai-h1", "subaru-forester", "toyota-prius", "bmw-x2", "jeep-cherokee", "tesla-model-y", "ford-fusion-black"];

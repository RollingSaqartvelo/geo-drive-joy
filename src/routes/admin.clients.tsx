...
import { Search, Phone, IdCard, CalendarDays } from "lucide-react";
import { loadBookings, type AdminBooking, type ContactType } from "@/lib/adminBookings";
  ...
  for (const b of bookings) {
    ...
    if (prev) {
      ...
      map.set(key, {
        ...
        contact: (b.clientContact || "whatsapp") as ContactType, count: 1, lastDate: b.pickupDate || "",
        cars: b.carName ? [b.carName] : [],
      });
    }
  }
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-gray-50 text-gray-400 text-xs uppercase tracking-wider">
                    ...
                    <th className="text-left font-bold px-4 py-3">Вод. удост.</th>
                ...
                <tbody>
                  {filtered.map((c, i) => (
                    <tr key={i} className="border-t border-gray-100 hover:bg-gray-50/60">
                      ...
                      <td className="px-4 py-3 text-gray-600 font-mono">{c.license || "—"}</td>

...
export const CARS: Car[] = [
  { name: "Ford Kuga (Escape)", slug: "ford-kuga-escape", year: 2019, seats: 5, price: 55, city: "batumi",
    images: [{ url: kuga1.url }, { url: kuga2.url }, { url: kuga3.url }, { url: kuga4.url }],
    tiers: [{ label: "1–3 days", price: 55 }, { label: "4–7 days", price: 50 }],
    plate: "BE-800-00",
  ...
  { name: "Toyota RAV4 Hybrid Plug-In", slug: "toyota-rav4-hybrid", year: 2023, seats: 5, price: 80, city: "batumi",
  ...
  { name: "Toyota RAV4 White", slug: "toyota-rav4-white", year: 2021, seats: 5, price: 80, city: "batumi",
    images: [{ url: "/rav4-white-1.webp" }, { url: "/rav4-white-2.webp" }, { url: "/rav4-white-3.webp" }, { url: "/rav4-white-4.webp" }],
    tiers: [{ label: "1–3 days", price: 80 }, { label: "4–7 days", price: 70 }, { label: "7–15 days", price: 65 }, { label: "15–30 days", price: 55 }],
    description: "Toyota RAV4 2021 Hybrid в белом цвете — полный привод AWD, экономичный гибридный двигатель, просторный и надёжный SUV для любых дорог Грузии.",
    specs: [{ label: "Engine", value: "2.5L Hybrid" }, { label: "Drive", value: "AWD" }, { label: "Seats", value: "5" }, { label: "Class", value: "SUV" }] },
  { name: "Toyota Sienna 8 Seats", slug: "toyota-sienna", year: 2015, seats: 8, price: 95, city: "batumi",
    images: [{ url: "/toyota-sienna-1.webp" }, { url: "/toyota-sienna-2.webp" }],
    tiers: [{ label: "1–3 days", price: 95 }, { label: "4–7 days", price: 85 }],
    description: "Toyota Sienna — просторный 8-местный минивэн, идеальный для больших семей и групповых поездок по Батуми и всей Грузии. Комфорт и вместительность для любого путешествия.",
    specs: [{ label: "Engine", value: "3.5L V6" }, { label: "Transmission", value: "Automatic" }, { label: "Seats", value: "8" }, { label: "Class", value: "Minivan" }] },
  { name: "Hyundai H1 11 Seats", slug: "hyundai-h1", year: 2015, seats: 11, price: 95, city: "batumi",
    images: [{ url: "/hyundai-h1-1.webp" }],
    tiers: [{ label: "1–3 days", price: 95 }, { label: "4–7 days", price: 85 }],
    description: "Hyundai H1 — вместительный 11-местный минивэн для больших компаний и групп. Просторный салон и комфорт для поездок по Батуми и всей Грузии.",
    specs: [{ label: "Transmission", value: "Automatic" }, { label: "Seats", value: "11" }, { label: "Class", value: "Minivan" }] },
  { name: "Mitsubishi Outlander 7 Seats", slug: "mitsubishi-outlander", year: 2019, seats: 7, price: 90, city: "batumi",
    images: [{ url: "/outlander-1.webp" }, { url: "/outlander-2.webp" }],
    tiers: [{ label: "1–3 days", price: 90 }, { label: "4–7 days", price: 85 }, { label: "8–15 days", price: 80 }],
    description: "Mitsubishi Outlander 2019 — просторный 7-местный кроссовер с полным приводом. Надёжный и вместительный SUV для семейных поездок и путешествий по Батуми и всей Грузии.",
    specs: [{ label: "Engine", value: "2.4L" }, { label: "Drive", value: "AWD" }, { label: "Seats", value: "7" }, { label: "Class", value: "SUV" }] },
  { name: "Nissan Quest", slug: "nissan-quest", year: 2013, seats: 7, price: 90, city: "batumi",
    images: [{ url: "/nissan-quest-1.webp" }, { url: "/nissan-quest-2.webp" }, { url: "/nissan-quest-3.webp" }, { url: "/nissan-quest-4.webp" }],
    tiers: [{ label: "1–3 days", price: 90 }, { label: "4–7 days", price: 85 }, { label: "8–15 days", price: 80 }],
    description: "Nissan Quest — просторный 7-местный минивэн с комфортным салоном и плавным ходом. Отличный выбор для больших семей и групповых поездок по Батуми и всей Грузии.",
    specs: [{ label: "Engine", value: "3.5L V6" }, { label: "Transmission", value: "CVT" }, { label: "Seats", value: "7" }, { label: "Class", value: "Minivan" }] },
  { name: "Lexus CT 200h Hybrid", slug: "lexus-ct200h", year: 2016, seats: 5, price: 50, city: "batumi",
    images: [{ url: "/lexus-ct200-1.webp" }, { url: "/lexus-ct200-2.webp" }, { url: "/lexus-ct200-3.webp" }, { url: "/lexus-ct200-4.webp" }, { url: "/lexus-ct200-5.webp" }, { url: "/lexus-ct200-6.webp" }, { url: "/lexus-ct200-7.webp" }, { url: "/lexus-ct200-8.webp" }],
    tiers: [{ label: "1–5 days", price: 50 }, { label: "6–15 days", price: 45 }],
  ...
  { name: "Subaru Crosstrek Limited", slug: "subaru-crosstrek-limited", year: 2022, seats: 5, price: 70, city: "batumi",
    ...
    tiers: [{ label: "1–3 days", price: 70 }, { label: "4–7 days", price: 65 }, { label: "7–15 days", price: 60 }, { label: "15–30 days", price: 45 }],
  ...
  { name: "Subaru Crosstrek Black", slug: "subaru-crosstrek-black", year: 2022, seats: 5, price: 70, city: "batumi",
  ...
  { name: "Ford Fusion Black", slug: "ford-fusion-black", year: 2018, seats: 5, price: 50, city: "batumi",
    images: [{ url: "/ford-fusion-black-1.webp" }, { url: "/ford-fusion-black-2.webp" }, { url: "/ford-fusion-black-3.webp" }, { url: "/ford-fusion-black-4.webp" }, { url: "/ford-fusion-black-5.webp" }, { url: "/ford-fusion-black-6.webp" }, { url: "/ford-fusion-black-7.webp" }, { url: "/ford-fusion-black-8.webp" }],
    tiers: [{ label: "1–3 days", price: 50 }, { label: "4–7 days", price: 47 }, { label: "7–15 days", price: 45 }, { label: "15–30 days", price: 40 }],
    description: "Ford Fusion 2018 в чёрном цвете — стильный и комфортный седан. Экономичный, вместительный и удобный для поездок по Батуми и всей Грузии.",
    specs: [{ label: "Engine", value: "2.5L" }, { label: "Transmission", value: "Automatic" }, { label: "Seats", value: "5" }, { label: "Class", value: "Sedan" }] },
  { name: "Ford Fusion Plug-In", slug: "ford-fusion-plugin", year: 2015, seats: 5, price: 50, city: "batumi",
    ...
    plate: "PV228PP", vin: "3FA6P0SU0HR163934", vehicleOwner: "EDO DAVITADZE", commission: 30 },
  { name: "Ford Fusion Hybrid Silver", slug: "ford-fusion-hybrid", year: 2019, seats: 5, price: 50, city: "batumi",
    images: [{ url: "/fusion-hybrid-1.webp" }, { url: "/fusion-hybrid-2.webp" }, { url: "/fusion-hybrid-3.webp" }, { url: "/fusion-hybrid-4.webp" }, { url: "/fusion-hybrid-5.webp" }, { url: "/fusion-hybrid-6.webp" }],
    tiers: [{ label: "1–3 days", price: 50 }, { label: "4–7 days", price: 47 }, { label: "7–15 days", price: 45 }, { label: "15–30 days", price: 40 }],
  ...
  { name: "Mercedes E450 Coupe", slug: "mercedes-e450-coupe", year: 2020, seats: 4, price: 205, city: "batumi",
    ...
    description: "Sleek black Mercedes-Benz E450 Coupe AMG Line — refined German luxury with a smooth turbocharged inline-6 and premium comfort for Batumi's roads.",
    specs: [{ label: "Engine", value: "3.0L I6 Turbo" }, { label: "Power", value: "362 HP" }, { label: "Transmission", value: "Automatic" }, { label: "Seats", value: "4" }, { label: "Class", value: "Luxury Coupe" }] },
  { name: "Ford Mustang Cabrio", slug: "ford-mustang-cabrio", year: 2020, price: 140, city: "batumi", images: [{ url: "/mustang-bw.webp" }, { url: "/mustang-2-new.webp" }, { url: "/mustang-3-new.webp" }],
    tiers: [{ label: "1–3 days", price: 140 }, { label: "4–7 days", price: 130 }, { label: "7–15 days", price: 120 }],
  ...
  { name: "Ford Mustang Cabrio Red", slug: "ford-mustang-cabrio-red", year: 2020, price: 140, city: "batumi",
    ...
    specs: [{ label: "Engine", value: "2.3L I4 Turbo" }, { label: "Power", value: "310 HP" }, { label: "Transmission", value: "Automatic" }, { label: "Seats", value: "4" }, { label: "Class", value: "Convertible" }] },
  { name: "Ford Mustang Cabrio 3.7L Dark Black", slug: "ford-mustang-cabrio-dark-black", year: 2016, seats: 4, price: 140, city: "batumi",
  ...
  { name: "Ford Mustang GT Cabrio Red", slug: "ford-mustang-gt-red", year: 2020, seats: 4, price: 140, city: "batumi",
    images: [{ url: "/mustang-gt-red-1.webp" }, { url: "/mustang-gt-red-2.webp" }, { url: "/mustang-gt-red-3.webp" }, { url: "/mustang-gt-red-4.webp" }, { url: "/mustang-gt-red-5.webp" }],
    tiers: [{ label: "1–3 days", price: 140 }, { label: "4–7 days", price: 130 }, { label: "7–15 days", price: 110 }],
    description: "Ford Mustang GT Convertible in bright red with aggressive Shelby styling — a powerful V8 open-top for unforgettable rides along Batumi's coastline.",
    specs: [{ label: "Engine", value: "5.9L V8" }, { label: "Transmission", value: "Automatic" }, { label: "Seats", value: "4" }, { label: "Class", value: "Convertible" }] },
  { name: "BMW 4 Series Cabrio Black", slug: "bmw-4-cabrio-black", year: 2020, seats: 4, price: 140, city: "batumi",
    images: [{ url: "/bmw-black-cabrio-1.webp" }, { url: "/bmw-black-cabrio-2.webp" }, { url: "/bmw-black-cabrio-3.webp" }, { url: "/bmw-black-cabrio-4.webp" }, { url: "/bmw-black-cabrio-5.webp" }],
    tiers: [{ label: "1–3 days", price: 140 }, { label: "4–7 days", price: 130 }, { label: "7–15 days", price: 120 }],
    description: "Sleek black BMW 4 Series Convertible M Sport — German luxury and dynamic performance with the top down along Batumi's seaside.",
    specs: [{ label: "Trim", value: "M Sport" }, { label: "Drive", value: "RWD" }, { label: "Transmission", value: "Automatic" }, { label: "Seats", value: "4" }, { label: "Class", value: "Convertible" }] },
  { name: "Chevrolet Camaro Black", slug: "chevrolet-camaro-black", year: 2020, seats: 4, price: 165, city: "batumi",
    images: [{ url: "/camaro-black-1.webp" }, { url: "/camaro-black-2.webp" }],
    tiers: [{ label: "1–3 days", price: 165 }, { label: "4–7 days", price: 135 }, { label: "7–15 days", price: 120 }],
    description: "Bold black Chevrolet Camaro — an iconic American muscle coupe with head-turning presence for Batumi's roads.",
    specs: [{ label: "Transmission", value: "Automatic" }, { label: "Seats", value: "4" }, { label: "Class", value: "Sports Coupe" }] },
  { name: "Tesla Model 3 White", slug: "tesla-model-3", year: 2022, seats: 5, price: 80, city: "batumi",
    images: [{ url: "/tesla-1.webp" }, { url: "/tesla-2.webp" }, { url: "/tesla-3.webp" }, { url: "/tesla-4.webp" }],
    tiers: [{ label: "1–3 days", price: 80 }, { label: "4–7 days", price: 70 }, { label: "7–30 days", price: 60 }],
    description: "Tesla Model 3 2022 в белом цвете — электромобиль с мгновенным разгоном, автопилотом и нулевыми расходами на топливо. Тихо, современно и экологично по дорогам Батуми и всей Грузии.",
    specs: [{ label: "Engine", value: "Electric" }, { label: "Drive", value: "RWD" }, { label: "Transmission", value: "Automatic" }, { label: "Seats", value: "5" }, { label: "Class", value: "Electric Sedan" }] },
  { name: "Range Rover Velar", slug: "range-rover-velar", year: 2021, seats: 5, price: 180, city: "batumi",
    images: [{ url: "/velar-1.webp" }, { url: "/velar-2.webp" }, { url: "/velar-3.webp" }, { url: "/velar-4.webp" }, { url: "/velar-5.webp" }],
    tiers: [{ label: "1–3 days", price: 180 }, { label: "4–7 days", price: 150 }, { label: "7–15 days", price: 140 }],
    description: "Range Rover Velar 2021 — элегантный премиальный кроссовер с безупречным дизайном, роскошным салоном и уверенным полным приводом. Стиль и комфорт для города и горных дорог Грузии.",
    specs: [{ label: "Drive", value: "AWD" }, { label: "Transmission", value: "Automatic" }, { label: "Seats", value: "5" }, { label: "Class", value: "Luxury SUV" }] },
  { name: "Hyundai Palisade", slug: "hyundai-palisade", year: 2021, seats: 8, price: 90, city: "batumi",
    images: [{ url: "/palisade-1.webp" }, { url: "/palisade-2.webp" }, { url: "/palisade-3.webp" }, { url: "/palisade-4.webp" }, { url: "/palisade-5.webp" }, { url: "/palisade-6.webp" }, { url: "/palisade-7.webp" }],
    tiers: [{ label: "1–3 days", price: 90 }, { label: "4–7 days", price: 80 }, { label: "7–15 days", price: 70 }],
    description: "Hyundai Palisade — просторный 8-местный премиум-кроссовер с кожаным салоном и тремя рядами сидений. Идеален для больших семей и групповых поездок по Батуми и всей Грузии.",
    specs: [{ label: "Engine", value: "3.8L V6" }, { label: "Drive", value: "AWD" }, { label: "Seats", value: "8" }, { label: "Class", value: "SUV" }] },
  { name: "Range Rover Sport", slug: "range-rover-sport", year: 2016, price: 185, city: "batumi", images: [rrw1, rrw2, rrw3],
    tiers: [{ label: "1–3 days", price: 185 }, { label: "4–7 days", price: 165 }, { label: "7–15 days", price: 145 }],
  ...
  { name: "Range Rover Sport Red", slug: "range-rover-sport-red", year: 2016, price: 185, city: "batumi", images: [rrred1, rrred2, rrred3],
    tiers: [{ label: "1–3 days", price: 185 }, { label: "4–7 days", price: 165 }, { label: "7–15 days", price: 145 }],
    description: "Striking red Range Rover Sport — turn heads on every road with British luxury and powerful V8 performance.",
    specs: [{ label: "Engine", value: "5.0L V8" }, { label: "Power", value: "510 HP" }, { label: "Transmission", value: "Automatic" }, { label: "Seats", value: "5" }, { label: "Class", value: "Luxury SUV" }], commissionFixed: 30 },
  { name: "Range Rover 7 Seats", slug: "range-rover-7-seats", year: 2018, seats: 7, price: 185, city: "batumi", images: [rr7a, rr7b, rr7c],
  ...
  { name: "BMW X3", slug: "bmw-x3", year: 2020, seats: 5, price: 135, city: "batumi",
    ...
    description: "BMW X3 2020 — премиальный кроссовер с мощным турбодвигателем, полным приводом xDrive, кожаным салоном и панорамной крышей. Комфорт и динамика на дорогах Батуми.",
    specs: [{ label: "Engine", value: "2.0L Turbo" }, { label: "Drive", value: "xDrive AWD" }, { label: "Transmission", value: "Automatic" }, { label: "Seats", value: "5" }, { label: "Class", value: "Luxury SUV" }],
    commission: 30 },
  { name: "Lexus GX 470", slug: "lexus-gx470", year: 2008, seats: 7, price: 70, city: "batumi", images: [gx1, gx2, gx3, gx4, gx5],
    tiers: [{ label: "1–3 days", price: 70 }, { label: "4–7 days", price: 65 }, { label: "7–15 days", price: 60 }, { label: "15+ days", price: 50 }],
    description: "Legendary Lexus GX 470 — a reliable 7-seat V8 SUV perfect for mountain roads and off-road adventures in Georgia.",
    specs: [{ label: "Engine", value: "4.7L V8" }, { label: "Power", value: "235 HP" }, { label: "Transmission", value: "Automatic" }, { label: "Seats", value: "7" }, { label: "Class", value: "SUV" }] },
  ...
  { name: "BMW 740i", slug: "bmw-740i", year: 2014, price: 155, city: "batumi", images: [{ url: "/bmw-740i-main.webp" }, bmw740a, bmw740b, bmw740c, bmw740d, bmw740e, bmw740f, bmw740g],
    tiers: [{ label: "1–3 days", price: 155 }, { label: "4–7 days", price: 145 }, { label: "7–15 days", price: 135 }],
  ...
  { name: "BMW X5 Hybrid", slug: "bmw-x5-hybrid", year: 2020, price: 130, city: "tbilisi", images: [x5a, x5b, x5c, x5e, x5f],
  ...
  { name: "Jeep Cherokee 2020", slug: "jeep-cherokee-2020", year: 2020, seats: 5, price: 85, city: "batumi",
    images: [{ url: "/jeep-cherokee-2020-1.webp" }, { url: "/jeep-cherokee-2020-2.webp" }, { url: "/jeep-cherokee-2020-3.webp" }, { url: "/jeep-cherokee-2020-4.webp" }, { url: "/jeep-cherokee-2020-5.webp" }, { url: "/jeep-cherokee-2020-6.webp" }, { url: "/jeep-cherokee-2020-7.webp" }],
    tiers: [{ label: "1–3 days", price: 85 }, { label: "4–7 days", price: 75 }, { label: "7–15 days", price: 65 }],
    description: "Jeep Cherokee 2020 в чёрном цвете — современный внедорожник с полным приводом, просторным салоном и уверенной проходимостью. Идеален для города и путешествий по Грузии.",
    specs: [{ label: "Engine", value: "3.2L V6" }, { label: "Drive", value: "4x4" }, { label: "Transmission", value: "Automatic" }, { label: "Seats", value: "5" }, { label: "Class", value: "SUV" }] },
  { name: "Jeep Cherokee", slug: "jeep-cherokee", year: 2018, seats: 5, price: 65, city: "batumi",
    images: [{ url: "/jeep-cherokee-1.webp" }, { url: "/jeep-cherokee-2.webp" }, { url: "/jeep-cherokee-3.webp" }, { url: "/jeep-cherokee-4.webp" }, { url: "/jeep-cherokee-5.webp" }, { url: "/jeep-cherokee-6.webp" }, { url: "/jeep-cherokee-7.webp" }, { url: "/jeep-cherokee-8.webp" }, { url: "/jeep-cherokee-9.webp" }],
    tiers: [{ label: "1–3 days", price: 65 }, { label: "4–7 days", price: 55 }, { label: "7–15 days", price: 50 }],
    description: "Jeep Cherokee Trailhawk — надёжный внедорожник с полным приводом 4x4, готовый к любым дорогам и бездорожью Грузии. Просторный салон и комфорт для путешествий.",
    specs: [{ label: "Engine", value: "3.2L V6" }, { label: "Drive", value: "4x4" }, { label: "Transmission", value: "Automatic" }, { label: "Seats", value: "5" }, { label: "Class", value: "Off-Road SUV" }] },
  { name: "BMW X2", slug: "bmw-x2", year: 2019, seats: 5, price: 85, city: "batumi",
    images: [{ url: "/bmw-x2-1.webp" }, { url: "/bmw-x2-2.webp" }, { url: "/bmw-x2-3.webp" }, { url: "/bmw-x2-4.webp" }, { url: "/bmw-x2-5.webp" }, { url: "/bmw-x2-6.webp" }, { url: "/bmw-x2-7.webp" }, { url: "/bmw-x2-8.webp" }, { url: "/bmw-x2-9.webp" }, { url: "/bmw-x2-10.webp" }],
    tiers: [{ label: "1–3 days", price: 85 }, { label: "4–7 days", price: 80 }, { label: "7–15 days", price: 65 }],
    description: "BMW X2 — стильный компактный кроссовер с динамичным характером, полным приводом и премиальным салоном. Отличный выбор для города и дорог Грузии.",
    specs: [{ label: "Engine", value: "2.0L Turbo" }, { label: "Drive", value: "AWD" }, { label: "Transmission", value: "Automatic" }, { label: "Seats", value: "5" }, { label: "Class", value: "Compact SUV" }] },
  ...
  { name: "Ford Escape", slug: "ford-escape", year: 2015, seats: 5, price: 55, city: "batumi",
    ...
    tiers: [{ label: "1–3 days", price: 55 }, { label: "4–15 days", price: 50 }, { label: "15–30 days", price: 45 }],
  ...
  { name: "Jeep Wrangler Sahara", slug: "jeep-wrangler-sahara", year: 2019, price: 175, city: "tbilisi", images: [wr19a, wr19b, wr19c, wr19d, wr19e, wr19f],
    tiers: [{ label: "1–3 days", price: 175 }, { label: "4–7 days", price: 145 }, { label: "8–15 days", price: 130 }],
  ...
  { name: "Mini Countryman Cooper S", slug: "mini-countryman-cooper-s", year: 2022, seats: 5, price: 75, city: "tbilisi",
    ...
    tiers: [{ label: "1–3 days", price: 75 }, { label: "4–15 days", price: 70 }, { label: "15–30 days", price: 50 }],
  ...
  { name: "BMW 430i", slug: "bmw-430i", year: 2016, seats: 4, price: 115, city: "tbilisi",
    images: [{ url: "/bmw430i-1.avif" }, { url: "/bmw430i-2.avif" }, { url: "/bmw430i-3.webp" }],
    tiers: [{ label: "1–3 days", price: 115 }, { label: "4–15 days", price: 105 }, { label: "15–30 days", price: 75 }],
  ...
  { name: "Mercedes GLE 350", slug: "mercedes-gle-350", year: 2020, seats: 5, price: 225, city: "tbilisi",
    ...
    tiers: [{ label: "1–2 days", price: 225 }, { label: "3–5 days", price: 205 }, { label: "5+ days", price: 185 }],
  ...
  { name: "Nissan Rogue Sport", slug: "nissan-rogue-sport", year: 2022, seats: 5, price: 65, city: "tbilisi",
    images: [{ url: "/nissan-rogue-1.avif" }, { url: "/nissan-rogue-2.webp" }, { url: "/nissan-rogue-3.avif" }, { url: "/nissan-rogue-4.avif" }],
    tiers: [{ label: "1–3 days", price: 65 }, { label: "4–7 days", price: 60 }, { label: "8–30 days", price: 45 }],
  ...
  { name: "Lexus RX 350", slug: "lexus-rx350", year: 2022, seats: 5, price: 115, city: "tbilisi",
    ...
    tiers: [{ label: "1–3 days", price: 115 }, { label: "4–7 days", price: 105 }, { label: "8–30 days", price: 80 }],
  ...
  { name: "Audi Q3", slug: "audi-q3", year: 2022, seats: 5, price: 75, city: "tbilisi",
    images: [{ url: "/audi-q3-1.avif" }, { url: "/audi-q3-2.avif" }, { url: "/audi-q3-3.avif" }, { url: "/audi-q3-4.avif" }],
    tiers: [{ label: "1–3 days", price: 75 }, { label: "4–7 days", price: 70 }, { label: "8–30 days", price: 55 }],
  ...
  { name: "Porsche Macan", slug: "porsche-macan", year: 2021, seats: 5, price: 240, city: "tbilisi",
    images: [{ url: "/porsche-macan-1.webp" }, { url: "/porsche-macan-2.webp" }, { url: "/porsche-macan-3.webp" }, { url: "/porsche-macan-4.webp" }, { url: "/porsche-macan-5.webp" }],
    tiers: [{ label: "1 day", price: 240 }, { label: "2–3 days", price: 170 }, { label: "4–7 days", price: 160 }, { label: "8–14 days", price: 150 }, { label: "15–30 days", price: 132 }, { label: "31+ days", price: 120 }],
    description: "Porsche Macan 2021 — компактный премиальный кроссовер с фирменной динамикой Porsche, полным приводом и роскошным салоном. Идеален для города и трасс Грузии.",
    specs: [{ label: "Engine", value: "2.0L Turbo" }, { label: "Drive", value: "AWD" }, { label: "Transmission", value: "Automatic" }, { label: "Seats", value: "5" }, { label: "Class", value: "Luxury SUV" }] },
  { name: "Porsche Cayenne Turbo", slug: "porsche-cayenne-turbo", year: 2012, seats: 5, price: 150, city: "tbilisi",
    images: [{ url: "/porsche-cayenne-1.webp" }, { url: "/porsche-cayenne-2.webp" }, { url: "/porsche-cayenne-3.webp" }, { url: "/porsche-cayenne-4.webp" }],
    tiers: [{ label: "2–3 days", price: 150 }, { label: "4–7 days", price: 140 }],
    description: "Porsche Cayenne Turbo 2012 — мощный премиальный внедорожник с двигателем V8 Twin-Turbo и роскошным салоном. Минимальный срок аренды — 2 дня. Идеален для города и трасс Грузии.",
    specs: [{ label: "Engine", value: "4.8L V8 Twin-Turbo" }, { label: "Power", value: "500 HP" }, { label: "Transmission", value: "Automatic" }, { label: "Seats", value: "5" }, { label: "Class", value: "Luxury SUV" }] },
  { name: "Porsche Boxster", slug: "porsche-boxster", year: 2007, seats: 2, price: 250, city: "tbilisi",
    images: [{ url: "/porsche-boxster-1.webp" }, { url: "/porsche-boxster-2.webp" }, { url: "/porsche-boxster-3.webp" }, { url: "/porsche-boxster-4.webp" }, { url: "/porsche-boxster-5.webp" }, { url: "/porsche-boxster-6.webp" }, { url: "/porsche-boxster-7.webp" }],
    tiers: [{ label: "1 day", price: 250 }, { label: "2–3 days", price: 180 }, { label: "4–7 days", price: 160 }],
    description: "Porsche Boxster в красном цвете — культовый спортивный родстер с открытым верхом и фирменной управляемостью Porsche. Незабываемые эмоции на горных дорогах Грузии.",
    specs: [{ label: "Engine", value: "2.7L Flat-6" }, { label: "Transmission", value: "Automatic" }, { label: "Seats", value: "2" }, { label: "Class", value: "Convertible" }] },
  { name: "Audi A5 Cabriolet", slug: "audi-a5-cabriolet", year: 2015, seats: 4, price: 120, city: "tbilisi",
    images: [{ url: "/audi-a5-1.webp" }, { url: "/audi-a5-2.webp" }, { url: "/audi-a5-3.webp" }, { url: "/audi-a5-4.webp" }],
    tiers: [{ label: "1–3 days", price: 120 }, { label: "4–7 days", price: 110 }, { label: "7–15 days", price: 100 }],
    description: "Audi A5 Cabriolet в чёрном цвете — стильный премиальный кабриолет с мягкой складной крышей. Опустите крышу и наслаждайтесь живописными горными дорогами Грузии с ветром в волосах.",
    specs: [{ label: "Engine", value: "2.0L TFSI" }, { label: "Drive", value: "quattro" }, { label: "Transmission", value: "Automatic" }, { label: "Seats", value: "4" }, { label: "Class", value: "Convertible" }] },
  { name: "Maserati Levante", slug: "maserati-levante", year: 2018, seats: 5, price: 180, city: "tbilisi",
    images: [{ url: "/maserati-levante-1.webp" }, { url: "/maserati-levante-2.webp" }],
    tiers: [{ label: "1–3 days", price: 180 }, { label: "4–7 days", price: 165 }, { label: "7–15 days", price: 155 }],
    description: "Maserati Levante в матовом чёрном цвете — итальянский люксовый кроссовер с харизматичным дизайном, мощным двигателем и фирменным звуком. Роскошь и статус на дорогах Тбилиси и всей Грузии.",
    specs: [{ label: "Engine", value: "3.0L V6 Twin-Turbo" }, { label: "Power", value: "350 HP" }, { label: "Transmission", value: "Automatic" }, { label: "Seats", value: "5" }, { label: "Class", value: "Luxury SUV" }] },
  { name: "Jeep Wrangler Rubicon Diesel", slug: "jeep-wrangler-rubicon-diesel", year: 2022, seats: 5, price: 155, city: "tbilisi",
    images: [{ url: "/wrangler-rubicon-1.avif" }, { url: "/wrangler-rubicon-2.avif" }, { url: "/wrangler-rubicon-3.avif" }, { url: "/wrangler-rubicon-4.avif" }],
    tiers: [{ label: "1 day", price: 155 }, { label: "2–3 days", price: 145 }, { label: "4–7 days", price: 135 }, { label: "8–30 days", price: 105 }],
  ...
  { name: "Mercedes GLC 300", slug: "mercedes-glc-300", year: 2023, seats: 5, price: 105, city: "tbilisi",
    images: [{ url: "/mercedes-glc-300-1.webp" }, { url: "/mercedes-glc-300-2.avif" }, { url: "/mercedes-glc-300-3.avif" }, { url: "/mercedes-glc-300-4.avif" }],
    tiers: [{ label: "1–7 days", price: 105 }, { label: "8–30 days", price: 85 }],
  ...
  { name: "Ford Bronco Badlands", slug: "ford-bronco-badlands", year: 2022, seats: 5, price: 225, city: "tbilisi",
    images: [{ url: "/ford-bronco-1.avif" }, { url: "/ford-bronco-2.avif" }, { url: "/ford-bronco-3.avif" }, { url: "/ford-bronco-4.avif" }],
    tiers: [{ label: "1 day", price: 225 }, { label: "2–3 days", price: 205 }, { label: "4–7 days", price: 185 }, { label: "8–30 days", price: 105 }],
  ...
  { name: "Ford Mustang Shelby", slug: "mustang-shelby-black", year: 2017, seats: 4, price: 135, city: "tbilisi",
    images: [{ url: "/mustang-shelby-1.webp" }, { url: "/mustang-shelby-2.webp" }, { url: "/mustang-shelby-3.webp" }, { url: "/mustang-shelby-4.webp" }, { url: "/mustang-shelby-5.webp" }],
    tiers: [{ label: "1–3 days", price: 135 }, { label: "4–7 days", price: 115 }, { label: "7–15 days", price: 105 }],

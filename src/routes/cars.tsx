...
import { Users, Calendar, MapPin, Crown, Sparkles, Building2, ShieldCheck, Shield, Clock, MessageCircle } from "lucide-react";
...
export const CARS: Car[] = [
  ...
  { name: "Ford Mustang GT Cabrio Red", slug: "ford-mustang-gt-red", year: 2020, seats: 4, price: 150, city: "batumi",
    ...
    tiers: [{ label: "1–3 days", price: 150 }, { label: "4–7 days", price: 140 }, { label: "7–15 days", price: 120 }],
  ...
  { name: "Chevrolet Camaro Black", slug: "chevrolet-camaro-black", year: 2020, seats: 4, price: 170, city: "batumi",
    images: [{ url: "/camaro-black-1.webp" }, { url: "/camaro-black-2.webp" }],
    tiers: [{ label: "1–3 days", price: 170 }, { label: "4–7 days", price: 140 }, { label: "7–15 days", price: 125 }],
  ...
  { name: "BMW X3", slug: "bmw-x3", year: 2020, seats: 5, price: 150, city: "batumi",
  ...
  { name: "Ford Mustang Shelby", slug: "mustang-shelby-black", year: 2017, seats: 4, price: 140, city: "tbilisi",
    ...
    tiers: [{ label: "1–3 days", price: 140 }, { label: "4–7 days", price: 120 }, { label: "7–15 days", price: 110 }],
...
function CarsPage() {
  ...
  return (
    <SiteLayout>
      ...
      {city === "batumi" && <VipTransfersSection />}
    </SiteLayout>
  );
}
...
export const CARS: Car[] = [
  ...
  { name: "Hyundai H1 8 Seats", slug: "hyundai-h1", year: 2015, seats: 8, price: 95, city: "batumi",
    images: [{ url: "/hyundai-h1-1.webp" }],
    tiers: [{ label: "1–3 days", price: 95 }, { label: "4–7 days", price: 85 }],
    description: "Hyundai H1 — вместительный 8-местный минивэн для больших компаний и семей. Просторный салон и комфорт для поездок по Батуми и всей Грузии.",
    specs: [{ label: "Transmission", value: "Automatic" }, { label: "Seats", value: "8" }, { label: "Class", value: "Minivan" }] },

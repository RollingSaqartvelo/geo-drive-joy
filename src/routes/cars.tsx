...
export const CARS: Car[] = [
  ...
  { name: "BMW 430i Cabriolet M Sport", slug: "bmw-430i-cabriolet", year: 2019, seats: 4, price: 140, city: "batumi",
    ...
    ownerTiers: [{ price: 110 }, { price: 100 }, { price: 90 }],
  ...
  { name: "Toyota RAV4 White", slug: "toyota-rav4-white", year: 2021, seats: 5, price: 75, city: "batumi",
  ...
  { name: "Subaru Forester 2016", slug: "subaru-forester-2016", year: 2016, seats: 5, price: 60, city: "batumi",
    images: [{ url: "/subaru-forester-2016-1.webp" }, { url: "/subaru-forester-2016-2.webp" }, { url: "/subaru-forester-2016-3.webp" }, { url: "/subaru-forester-2016-4.webp" }, { url: "/subaru-forester-2016-5.webp" }, { url: "/subaru-forester-2016-6.webp" }],
    tiers: [{ label: "1–3 days", price: 60 }, { label: "4–7 days", price: 55 }, { label: "7–15 days", price: 50 }],
    description: "Subaru Forester 2016 — надёжный полноприводный кроссовер с просторным салоном. Отличный выбор для поездок по Батуми и горным маршрутам Грузии.",
    specs: [{ label: "Engine", value: "2.5L" }, { label: "Drive", value: "AWD" }, { label: "Seats", value: "5" }, { label: "Class", value: "SUV" }] },
  ...
  { name: "Mercedes CLS 55", slug: "mercedes-cls-55", year: 2013, seats: 5, price: 150, city: "batumi",
    images: [{ url: "/mercedes-cls-1.webp" }, { url: "/mercedes-cls-2.webp" }, { url: "/mercedes-cls-3.webp" }, { url: "/mercedes-cls-4.webp" }, { url: "/mercedes-cls-5.webp" }, { url: "/mercedes-cls-6.webp" }],
    tiers: [{ label: "1 day", price: 150 }, { label: "2–4 days", price: 130 }, { label: "5–15 days", price: 110 }],
    description: "Mercedes-Benz CLS в чёрном цвете — элегантное 4-дверное купе с мощным двигателем и премиальным салоном. Стиль и статус на дорогах Батуми и всей Грузии.",
    specs: [{ label: "Transmission", value: "Automatic" }, { label: "Seats", value: "5" }, { label: "Class", value: "Luxury Sedan" }] },
  ...
  { name: "Dodge Grand Caravan", slug: "dodge-grand-caravan", year: 2006, seats: 7, price: 130, city: "tbilisi",
    images: [{ url: "/dodge-caravan-1.webp" }, { url: "/dodge-caravan-2.webp" }, { url: "/dodge-caravan-3.webp" }],
    tiers: [{ label: "1 day", price: 130 }, { label: "2–3 days", price: 95 }, { label: "4–7 days", price: 80 }, { label: "8–14 days", price: 65 }, { label: "15–30 days", price: 55 }, { label: "31+ days", price: 40 }],
    description: "Dodge Grand Caravan — просторный 7-местный минивэн с автоматической коробкой. Идеален для семейных поездок и групповых туров по Грузии. Депозит $200.",
    specs: [{ label: "Fuel", value: "Premium (AI95)" }, { label: "Transmission", value: "Automatic" }, { label: "Seats", value: "7" }, { label: "Color", value: "White" }, { label: "Class", value: "Minivan" }],
    plate: "KF987KF" },
